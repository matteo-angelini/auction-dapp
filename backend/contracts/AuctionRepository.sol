...
contract AuctionRepository {
     ...
     * @return blockDeadline timestamp of the auction in which it expires
     * @return startPrice starting price of the auction
     * @return metadata representing the metadata of the auction
     * @return deedId ID of the deed registered in DeedRepository
     * @return deedRepositoryAddress Address of the DeedRepository
